...
import com.example.opengllk.refer.data.VertexArray;
import com.example.opengllk.refer.programs.ParticleShaderProgram;
import com.example.opengllk.refer.util.Geometry.*;

import static com.example.opengllk.refer.Constants.BYTES_PER_FLOAT;

public class ParticleSkyBoxSystem {
    ...
    public ParticleSkyBoxSystem(int maxParticleCount) {
